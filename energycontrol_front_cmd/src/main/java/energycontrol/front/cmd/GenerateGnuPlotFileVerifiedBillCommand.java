...
public class GenerateGnuPlotFileVerifiedBillCommand extends Command 
{
	private ResourceBundleReader resourceBundleReader;
	private EnergyControlBackService backService;
	
	public GenerateGnuPlotFileVerifiedBillCommand(ResourceBundleReader resourceBundleReader, Scanner scanner, EnergyControlBackService backService) 
	{
		super(scanner);
	...
	public ActionResult execute() 
	{
		...
		else
		{
			...
			else
			{
				...
				//Generar el archivo .dat para GnuPlot
				GenericActionResult<String>  gar = this.backService.generateGnuPlotFileVerifiedBill(sBillNumber, sMSourceCode);
